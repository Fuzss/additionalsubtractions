...
import fuzs.additionalsubtractions.neoforge.world.level.block.NeoForgeFireBlock;
...
public class NeoForgeModRegistry {
    ...
    public static final Holder.Reference<Block> COPPER_SULFATE_FIRE = REGISTRIES.registerBlock("copper_sulfate_fire",
            NeoForgeFireBlock::new,
